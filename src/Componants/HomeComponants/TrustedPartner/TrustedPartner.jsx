...
const TrustedPartner = () => {
  const [partners] = usePartners()
    ...
    return (
        <div className='py-10'>
            <Heading heading="Our Trusted Partner
" paragraph="We collaborate with industry leaders who share our commitment to quality, innovation, and craftsmanship.
Together, we create apparel that blends style, durability, and excellence"></Heading>
